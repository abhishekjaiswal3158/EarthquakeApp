...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
       ...
       JSONArray rootarray=root.optJSONArray("features");
       for(int i=0;i<rootarray.length();i++){
       JSONObject arrayobject=rootarray.optJSONObject(i);
       JSONObject  property=arrayobject.optJSONObject("properties");
       Double mag=property.optDouble("mag");
           DecimalFormat magnitudeFormat = new DecimalFormat("0.0");
       String mag1 = magnitudeFormat.format(mag);
       String loc=property.optString("place");
           ...
           String ct= timeFormat.format(dateObject);
       Earthquake earth=new Earthquake(mag1,loc1+" of ",loc2,dateToDisplay,ct);
